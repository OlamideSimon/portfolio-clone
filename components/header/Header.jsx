...
const styles = {
    ...
    soonButton: 'absolute text-slate-200 opacity-50 -top-7 right-0 bg-purple px-3 py-1 text-sm capitalize cursor-not-allowed rounded-tl-xl rounded-br-xl',
    ...
    linkContainer: 'flex items-center flex-col space-y-10 pt-[80px] text-3xl font-corpsansbold',
    contactMeContainer: 'bg-blue-900 font-corpsansmedium rounded-br-3xl rounded-tl-3xl p-10 md:p-20 text-center md:flex md:justify-between items-center',
